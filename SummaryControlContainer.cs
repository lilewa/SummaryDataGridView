    ...
    public class SummaryControlContainer : Control
    {
        ...
        private void calcSummaries()
        {
            ...
            if (dgv.SummaryColumns != null && dgv.SummaryColumns.Length > 0 && sumBoxHash.Count > 0)
            {
                ...
                //    SizeF sf = gh.MeasureString(sumBox.Text, sumBox.Font);
        ...
        private void reCreateSumBoxes()
        {
            ...
            foreach (DataGridViewColumn dgvColumn in sortedColumns)
            {
                ...
                //第一次查询font是dgv的默认字号。第二次才变成 DataGridViewSummary 绑定事件中赋值的font
               // RowsDefaultCellStyle.Font = new Font("宋体", cellFontSize);
              //  sumBox.Font = dgv.RowsDefaultCellStyle.Font; 
                sumBox.Font =new Font("宋体", dgv.CellerFontSize);
            ...
            if (dgv.DisplaySumRowHeader)
            {
              ...
              //  sumRowHeaderLabel.Height = sumRowHeaderLabel.Font.Height;
                ...
                sumRowHeaderLabel.Font = new System.Drawing.Font("宋体", dgv.HeaderFontSize, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
